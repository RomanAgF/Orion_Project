...
let hints = document.querySelectorAll (
    ...
    half = document.querySelectorAll (
    ".millionaire-hints__hint-half:not(.millionaire-hints__hint_disabled)"
),
    hindoublets = document.querySelectorAll (
...
let gameOptions,
    ...
    //ввод после попытки начать без ввода имени
...
this.setStep =function () {
    progressList.children[that.step].classList.add(
        'millionaire-progress__item_active'
    );
...
this.getQuestions = function () {
    ...
    that.questions = data[that.compexity];
};
    this.getQuestions = function () {
    ...
    this.setQuestion = function () {
        question.innerText = that.currentRoundquestion;
...
this.timerStop = function () {
    ...
    document
        ...
        .classList.add('millionaire-timer__bg_based');
};
